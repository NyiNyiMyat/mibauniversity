...
<hr>
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/miniimages/'.$student->pro)); ?>" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/miniimages/'.$student->nrcf)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/miniimages/'.$student->nrcb)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/miniimages/'.$student->pay)); ?>" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="<?php echo e(asset('storage/miniimages/'.$student->pro)); ?>" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/miniMba/index.blade.php ENDPATH**/ ?>