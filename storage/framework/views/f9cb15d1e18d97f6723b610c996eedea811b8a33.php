...
<section class="counts section-bg">
    <div class="container-fluid">
        <div class="row">
             <div class="col-md-12">
                 <img src="<?php echo e(asset('images/banner/1-3 (1).jpg')); ?>" class="img-fluid"  style="width:100%;">
             </div>
        </div>
    </div>
...
If you remain unsatisfied after our complaints process has been completed, you can complain to CEO ,Pacific Prime Business School by email with <font style="color:blue;">ceo@ppbsmyanmar.com</font><br>
            ...
            <div class="col-md-4">
                ...
                <div style="background-color:lightgray;padding:5px;">
                 ...
                 <h4 style="font-size:18px;color:#000;line-height:2;"><b><a href="<?php echo e(route('Alumni-Privacy-Notice')); ?>">Alumni Privacy Notice</a></b></h4>
             </div>
             
             <div class="count-box" style="padding:10px;margin:10px;background-color:rgba(255, 255, 255, 0.93);">
                 <h4 style="font-size:18px;color:#000;line-height:2;"><b><a href="<?php echo e(route('Marketing-Privacy-Notice')); ?>">Marketing Privacy Notice</a></b></h4>
             </div>
             
              <div class="count-box" style="padding:10px;margin:10px;background-color:rgba(255, 255, 255, 0.93);">
                 <h4 style="font-size:18px;color:#000;line-height:2;"><b><a href="<?php echo e(route('Student-Privacy-Notice')); ?>">Student Privacy Notice</a></b></h4>
             </div>
             
              <div class="count-box" style="padding:10px;margin:10px;background-color:rgba(255, 255, 255, 0.93);">
                 <h4 style="font-size:18px;color:#000;line-height:2;"><b><a href="<?php echo e(route('Story-Photo-Privacy-Notice')); ?>">Story Photo Privacy Notice</a></b></h4>
             </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/frontend/privacy-and-data-protection.blade.php ENDPATH**/ ?>