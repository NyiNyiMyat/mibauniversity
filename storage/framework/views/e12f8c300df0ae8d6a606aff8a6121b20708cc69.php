            ...
            <div class="carousel-container">
              ...
              <h2 class="animate__animated animate__fadeInDown">
               MIBA University</h2>
                ...
                <a href="<?php echo e(route('the-school')); ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto" style="bak">Read More</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(<?php echo e(asset('images/slide/3.png')); ?>);">
            <div class="carousel-container">
              ...
              <h2 class="animate__animated animate__fadeInDown">
                ...
                <!-- Slide 4 -->
                <div class="carousel-item" style="background-image: url(<?php echo e(asset('images/slide/web412.jpg')); ?>);">
            <div class="carousel-container">
              <div class="carousel-content container">
              <h2 class="animate__animated animate__fadeInDown">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mibauni\resources\views/frontend/index.blade.php ENDPATH**/ ?>