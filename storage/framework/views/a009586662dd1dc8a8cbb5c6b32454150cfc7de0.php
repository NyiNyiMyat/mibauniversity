        ...
        <div class="col-12 col-lg-12">
            <div class="row">
                <div class="col-12 col-lg-12 col-md-12">
                  ...
                  <img src="<?php echo e(asset('images/banner/abeba.png')); ?>" class="img-fluid"  style="border-radius: 30px;border:3px solid blue;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Add New ABE Student / <a href="<?php echo e(route('abebackendZoom.index')); ?>">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="<?php echo e(route('abebackendZoom.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="tab">
                          <font style="color:red;font-size:35px;">*</font> required<br>
                                          ...
                                          <div class="form-group">
                                            <label for="usr"><h6><font style="font-size: 15px;">Choose Your Profile Photo</font><font style="color:red;font-size:35px;">*</font></h6></label>
                                            <br>
                    ...
                    <option value="Digital Campus">Digital Campus</option>
                                          ...
                                          <div class="form-group">
                                            <label for="usr"><h6 style="font-size: 15px;">Choose Your Payment Screenshot<font style="color:red;font-size:35px;">*</font></h6></label>
                                            <br>
                                          ...
                                          <div class="form-group">
                                           <label for="usr"><h6 style="font-size: 15px;">Choose Your N.R.C Front Image<font style="color:red;font-size:35px;">*</font></h6></label>
                                           <br>
                                          ...
                                          <div class="form-group">
                                            <label for="usr"><h6 style="font-size: 15px;">Choose Your N.R.C Back Image<font style="color:red;font-size:35px;">*</font></h6></label>
                                            <br>
                        ...
                        <label for="usr">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                               <label for="usr"><h6 style="font-size: 15px;">Student's Address<font style="color:red;font-size:35px;">*</font></h6></label>
                        ...
                        <div class="tab">
                          <h5>Emergency Contact Information Please provide name, relationship and phone number of an emergency</h5>
                           <div class="form-group">
                               <label for="usr"><h6 style="font-size: 15px;">Name<font style="color:red;font-size:35px;">*</font></h6></label>
                               <input type="text" class="form-control" id="usr" name="em_name" placeholder="Enter Name" oninput="this.className = ''" required>
                            </div>
                            
                            <div class="form-group">
                               <label for="usr"><h6 style="font-size: 15px;">Relationship<font style="color:red;font-size:35px;">*</font></h6></label>
                               <input type="text" class="form-control" id="usr" name="em_rela" placeholder="Enter Relationship" oninput="this.className = ''" required>
                            </div>
                            
                             <div class="form-group">
                               <label for="usr"><h6 style="font-size: 15px;">Phone Number<font style="color:red;font-size:35px;">*</font></h6></label>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/abebackendZoom/create.blade.php ENDPATH**/ ?>