...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      ...
      <li><a class="dropdown-item" href="<?php echo e(asset('storage/certiimages/'.$certificate->pro)); ?>" download><span class="fa-fw select-all fas"></span> Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/certiimages/'.$certificate->nrcf)); ?>" download><span class="fa-fw select-all fas"></span> N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/certiimages/'.$certificate->nrcb)); ?>" download><span class="fa-fw select-all fas"></span> N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/certiimages/'.$certificate->pay)); ?>" download><span class="fa-fw select-all fas"></span> Payment Screenshot Image</a></li>
...
<tbody>
    <tr style="color:#000;">
     <th colspan="3"></th>
     <th><img src="<?php echo e(asset('storage/certiimages/'.$certificate->pro)); ?>" style="width:100px;height:100px"></th>
    </tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/certificatebackend/detail.blade.php ENDPATH**/ ?>