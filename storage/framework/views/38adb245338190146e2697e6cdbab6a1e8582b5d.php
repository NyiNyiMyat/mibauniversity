            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add SBS MBA Student / <a href="<?php echo e(route('sbsbackend.index')); ?>">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="<?php echo e(route('sbsbackend.store')); ?>" method="post" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
						...
						<option value="Digital Campus">Digital Campus</option>
						  ...
						  <div class="switch-wrap d-flex justify-content-between">
										...
										<div class="primary-checkbox">
											...
											<label for="primary-checkbox"></label>Agree 
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/sbsbackend/create.blade.php ENDPATH**/ ?>