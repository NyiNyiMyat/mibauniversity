...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="<?php echo e(route('abebackendZoom.create')); ?>">Add New Student</a></li>
    </ul>
  </div>
</div>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;">
                    ...
                    <tbody>
                        <?php ($no=1); ?>
                        <?php $__currentLoopData = $abestudentsZoom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/abezoomimages/'.$student->pro)); ?>" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/abezoomimages/'.$student->nrcf)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/abezoomimages/'.$student->nrcb)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/abezoomimages/'.$student->pay)); ?>" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div></td>
                            <td>
                            <a href="#" data-bs-toggle="modal"
                                data-bs-target="#exampleModalLong1<?php echo e($student->id); ?>">
                                <img src="https://img.icons8.com/color/28/000000/filled-sent.png"/>
                            </a>
                            </td>
                            
                            <td>
                            <a href="<?php echo e(route('abebackendZoom.edit',$student->id)); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="<?php echo e(route('abebackendZoom.destroy',$student->id)); ?>" method="POST">
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="<?php echo e(asset('storage/abezoomimages/'.$student->pro)); ?>" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="<?php echo e(route('abebackendZoom.show',$student->id)); ?>" style="color:#000;">
                          ...
                          <!-------------------------end details--------------------->
                               ...
                               <!--scrollbar Modal -->
                               <div class="modal fade" id="exampleModalLong1<?php echo e($student->id); ?>" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    name="fullname" value="<?php echo e($student->fullname); ?>" readonly>
                                                </div>
                                            </div>
                            ...
                            <label>Something Write</label>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    name="dobupload" value="<?php echo e($student->email); ?>">
                                                </div>
                                            </div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mibauni\resources\views/backend/abebackendZoom/index.blade.php ENDPATH**/ ?>