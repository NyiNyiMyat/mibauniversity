            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New IQN Student / <a href="<?php echo e(route('iqnbackendpos.index')); ?>">Back</a></h4>
                    </div>
          
                    <div class="card-content">
                        <div class="card-body">
                            <h3><img src="<?php echo e(asset('images/logo/iqn.png')); ?>" class="img-fluid" style="width:140px;"></h3>
                    <div class="col-md-12 col-12">
                    <form id="regForm" action="<?php echo e(route('iqnbackendpos.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                          ...
                          <font style="color:red;font-size:15px;">*</font> required<br>
                                          ...
                                          <div class="form-group" style="font-size: 15px;">
                                            <label for="sel1"><h6><font style="font-size:15px;">Course</font><font style="color:red;font-size:15px;">*</font></h6></label>
                                              <select id="inputGroupSelect01" onchange="changeStatus()" class="form-select mb-3" aria-label=".form-select-lg example" name="course" required="required">
      ...
      if(status.value == "Post Graduate Diploma in Business Management"){
          ...
          document.getElementById("vie").style.visibility="hidden";
                                          ...
                                          <div class="form-group" id="vie">
                                            ...
                                            <br>
                                            <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal1de" style="text-decoration:none;">
                                            <img src="https://img.icons8.com/flat-round/24/000000/arrow--v1.png"/>
                                            Upload Your Degree file ( only Post Graduate Diploma in Business Management )
                                            </a>
                    ...
                    <option value="Online Learning (Zoom Class)">Online Learning (Zoom Class)</option>
                      ...
                      (၁) PPBS Business School တွင် တက်ရောက်သင်ကြားနေကြသည့် ကျောင်းသားကျောင်းသူများအနေဖြင့် သင်ကြားမှု သင်ယူမှုတွင် ပိုမိုအာရုံစူးစိုက် သင်ကြားနိုင်ရန် နှင့် စနစ်ကျသော Online Learning သင်ကြားမှုပုံစံ ဖြစ်မြောက်စေရန်အတွက် အောက်ပါ စည်းကမ်းချက်များကို ကူညီ၍ လိုက်နာဆောင်ရွက်ပေးပါရန် လေးစားစွာဖြင့် မေတ္တာရပ်ခံအပ်ပါသည်။<br>
                      (၂) PPBs Business School တွင် သင်ခန်းစာများအား Online မှတဆင့် လေ့လာသင်ယူရန်အတွက် သင်တန်းသား အကောင့်ပြုလုပ်ထားသည့် ကျောင်းသား ကျောင်းသူများသည် သတ်မှတ်ထားသော Registration Form တွင် မိမိတို့၏ ကိုယ်ရေးအချက်အလက်များကို ပြည့်စုံစွာ ထည့်သွင်းရမည်ဖြစ်ပါသည်။<br>
                        ...
                        <div class="modal fade text-left" id="myModal1de" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                    <input type="file" oninput="this.className = ''" onchange="up1de()" name="degreefile" id="pdf_file" class="form-control">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/iqnbackendpos/create.blade.php ENDPATH**/ ?>