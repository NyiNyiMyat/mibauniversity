        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <center><img src="<?php echo e(asset('images/logo/logo.png')); ?>" class="img-fluid"></center>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>
                        <h4 class="mt-3"><center> <?php echo e(__('Sign in to MIBA')); ?></center></h4>
                        <div class="row mb-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mibauni\resources\views/auth/login.blade.php ENDPATH**/ ?>