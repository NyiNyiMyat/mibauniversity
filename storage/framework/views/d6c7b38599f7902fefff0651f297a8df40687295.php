            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New ABE Student / <a href="<?php echo e(route('abebackend.index')); ?>">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="<?php echo e(route('abebackend.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                      ...
                      Technology">Professional Diploma in Information Technology
                                          ...
                                          <div class="form-group">
                                            <label for="sel1"><h6>
                                                <font style="font-size:15px;">Campus</font>
                                                <font style="color:red;font-size:15px;">*</font></h6></label>
                    ...
                    <option value="Online-Learning-(Zoom-Class)">Online Learning (Zoom Class)</option>
                        ...
                        <font style="color:red;">Terms & Conditions for Pacific Prime Business School Students</font>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/abebackend/create.blade.php ENDPATH**/ ?>