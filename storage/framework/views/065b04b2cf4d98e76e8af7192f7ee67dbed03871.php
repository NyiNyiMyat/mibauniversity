...
<div class="col-lg-6">
  ...
  <div class="card card-body">
      ...
      <img src="<?php echo e(asset('storage/accproimg/'.Auth::user()->photo)); ?>" style="width:150px;height:150px;border-radius:100%;">
       </center>
...
<?php echo method_field('PUT'); ?>      
       <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="3">  <?php echo e(Auth::user()->address); ?></textarea>
                                      </div>
...
<iframe src="<?php echo e(asset('storage/payment/payment_pdf/'.$student->total_payment)); ?>" id="img1" class="img-fluid" allowfullscreen></iframe>
</div>
</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/frontend/dashboard.blade.php ENDPATH**/ ?>