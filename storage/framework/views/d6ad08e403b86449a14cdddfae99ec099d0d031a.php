...
<form id="regForm" action="<?php echo e(route('iqndiploma.store')); ?>" method="post" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
							<h3><img src="<?php echo e(asset('images/logo/iqn.png')); ?>" class="img-fluid" style="width:130px;"></h3>
							  ...
							  <script type="text/javascript">
								  ...
								  reader.readAsDataURL(event.target.files[0]);
											  ...
											  <div class="form-group">
												<label for="usr"><h6><font style="font-size: 15px;">Choose Your Profile Photo</font><font style="color:red;font-size:30px;">*</font></h6></label>
												<br>
      ...
      <h5 class="modal-title" id="myModalLabel1">Your Profile Photo</h5>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
												...
												<input type="file"  oninput="this.className = ''" required="required" onchange="up1()" name="pro" class="form-control-file border" required>
											  ...
											  <div class="form-group" style="font-size: 15px;">
												<label for="sel1"><h6><font style="font-size:15px;">Course</font><font style="color:red;font-size:30px;">*</font></h6></label>
												  <select class="form-select form-select-lg" aria-label="Default select example" id="inputGroupSelect01" onchange="changeStatus()" name="course" required="required">
						  ...
						  <option value="Post Graduate Diploma in Business Management">
                    ...
                    <div class="form-group" id="vie">
					<label for="usr"><h6><font style="font-size: 15px;">
					Choose Your Degree file (only PDF)</font><font style="color:red;font-size:35px;">*</font></h6></label>
                                            <br>
                                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModalde" style="text-decoration:none;">
                                            <img src="https://img.icons8.com/flat-round/24/000000/arrow--v1.png"/>
                                            Upload Your Degree file ( Only For Post Graduate Diploma in Business Management )
                                            </a>				  
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							...
							<label for="usr">
								...
								<div class="form-group">
								 ...
								 <div class="form-group">
								   <label for="usr"><h6 style="font-size: 15px;">Student's Phone</h6><font style="color:red;font-size:30px;">*</font></label>
							...
							<div class="tab">
							  <h5>Emergency Contact Information Please provide name, relationship and phone number of an emergency</h5>
							   <div class="form-group">
								   <label for="usr"><h6 style="font-size: 15px;">Name<font style="color:red;font-size:30px;">*</font></h6></label>
								   <input type="text" class="form-control" id="usr" name="em_name" placeholder="Enter Name" oninput="this.className = ''" required>
								</div>
								
								<div class="form-group">
								   <label for="usr"><h6 style="font-size: 15px;">Relationship<font style="color:red;font-size:30px;">*</font></h6></label>
								   <input type="text" class="form-control" id="usr" name="em_rela" placeholder="Enter Relationship" oninput="this.className = ''" required>
								</div>
								
								 <div class="form-group">
								   <label for="usr"><h6 style="font-size: 15px;">Phone Number<font style="color:red;font-size:30px;">*</font></h6></label>
 ...
 <div class="modal fade" id="myModalde">
    <div class="modal-dialog modal-dialog-centered">
      ...
      <h5 class="modal-title" id="myModalLabel1">Your Degreefile (only pdf)</h5>
        ...
        <!-- Modal body -->
        <div class="modal-body">
		<input type="file"  oninput="this.className = ''" required="required" onchange="up1de()" name="degreefile" class="form-control">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/frontend/iqndiplomapage.blade.php ENDPATH**/ ?>