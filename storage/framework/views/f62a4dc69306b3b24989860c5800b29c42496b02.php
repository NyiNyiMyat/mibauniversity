            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('sbsbackend.index')); ?>">Back</a></li>
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      ...
      <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/sbsmbaimages/sbsimages/'.$sbsstudent->pro)); ?>" download><span class="fa-fw select-all fas"></span> Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/sbsmbaimages/degree/'.$sbsstudent->degreefile)); ?>" download><span class="fa-fw select-all fas"></span> Degree File</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/sbsmbaimages/sbsimages/'.$sbsstudent->nrcf)); ?>" download><span class="fa-fw select-all fas"></span> N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/sbsmbaimages/sbsimages/'.$sbsstudent->nrcb)); ?>" download><span class="fa-fw select-all fas"></span> N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/sbsmbaimages/sbsimages/'.$sbsstudent->pay)); ?>" download><span class="fa-fw select-all fas"></span> Payment Screenshot Image</a></li>
...
<tbody>
    <tr style="color:#000;">
     ...
     <th><img src="<?php echo e(asset('storage/app/public/sbsmbaimages/sbsimages/'.$sbsstudent->pro)); ?>" style="width:100px;height:100px"></th>
    </tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/sbsbackend/detail.blade.php ENDPATH**/ ?>