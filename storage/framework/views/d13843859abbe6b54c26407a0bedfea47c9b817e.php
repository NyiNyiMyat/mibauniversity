...
<?php endif; ?>
	                    <form id="regForm" action="<?php echo e(route('miniMba.store')); ?>" method="POST" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
						<h3><img src="<?php echo e(asset('images/logo/4.png')); ?>" class="img-fluid" style="width:100px;"> MINI MBA</h3>
  ...
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <option value="Online Learning (Zoom Class)">Online Learning (Zoom Class)</option>
						  ...
						  reader.readAsDataURL(event.target.files[0]);
									  ...
									  <div class="form-group">
										<label for="usr"><h6 style="font-size: 15px;">Choose Your Payment Screenshot (pay)<font style="color:red;font-size:30px;">*</font></h6></label>
										<br>
  ...
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							...
							<div class="tab">
							  <h5>Personal Particulars</h5>
								<div class="form-group">
								   <label for="usr"><h6 style="font-size: 15px;">Full Name <font style="font-size: 30px;color:red;">*</font></h6></label>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/frontend/minimbapage.blade.php ENDPATH**/ ?>