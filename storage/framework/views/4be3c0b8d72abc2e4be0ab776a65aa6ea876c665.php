...
<?php endif; ?>
	                    ...
	                    <form id="regForm" action="<?php echo e(route('certificate.store')); ?>" method="POST" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
						<h3><img src="<?php echo e(asset('adminDemo/images/logo/4.png')); ?>" class="img-fluid" style="width:100px;"></h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/frontend/Certificatepage.blade.php ENDPATH**/ ?>