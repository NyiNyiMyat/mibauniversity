            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mini MBA Student Details / <a href="<?php echo e(route('miniMba.index')); ?>">Back</a></h4>
                    </div>
...
<hr>
                    ...
                    <div class="col-md-12 col-12">
                                ...
                                <hr>
                                <form class="form" action="<?php echo e(route('miniMba.update',$mini->id)); ?>" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="course" value="<?php echo e($mini->course); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="campus" value="<?php echo e($mini->campus); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="intake" value="<?php echo e($mini->intake); ?>">
                                        </div>
                                    </div>
...
<div class="form-group">
      <label for="first-name-column"><h6><font style="font-size:15px;">Learning Type</font></h6></label>
        <select class="form-select" aria-label=".form-select-lg example" name="type" required="required">
            <option selected><?php echo e($mini->type); ?></option>
...
<option value="Online-Learning-(Zoom-Class)">Online Learning (Zoom Class)</option>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="fullname" value="<?php echo e($mini->fullname); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($mini->gender); ?>" name="gender">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="nrc" value="<?php echo e($mini->nrc); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nation" value="<?php echo e($mini->nation); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="relig" value="<?php echo e($mini->relig); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="father" value="<?php echo e($mini->father); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="stu_ph" value="<?php echo e($mini->stu_ph); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="email" value="<?php echo e($mini->email); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="address" value="<?php echo e($mini->address); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="occupation" value="<?php echo e($mini->occupation); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="com_name" value="<?php echo e($mini->com_name); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="com_ph" value="<?php echo e($mini->com_ph); ?>">
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-column" class="form-control"
                         name="ad_year" value="<?php echo e($mini->ad_year); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="last-name-column" class="form-control"
                        value="<?php echo e($mini->university); ?>" name="university">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="city-column" class="form-control"
                            name="degree" value="<?php echo e($mini->degree); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="country-floating" class="form-control"
                            name="major" value="<?php echo e($mini->major); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="location" value="<?php echo e($mini->location); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="company-column" class="form-control"
                            name="certificate" value="<?php echo e($mini->certificate); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="ad_date" value="<?php echo e($mini->ad_date); ?>">
                    </div>
                </div>
                ...
                <br><br>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_name" value="<?php echo e($mini->em_name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-column" class="form-control"
                                            name="em_rela" value="<?php echo e($mini->em_rela); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_comph" value="<?php echo e($mini->em_comph); ?>">
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/app/public/miniimages/'.$mini->pro)); ?>" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/app/public/miniimages/'.$mini->pay)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/app/public/miniimages/'.$mini->nrcf)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/app/public/miniimages/'.$mini->nrcb)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/miniMba/edit.blade.php ENDPATH**/ ?>