        ...
        <div class="row">
            <div class="col-4 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert">
                            <img src="<?php echo e(asset('images/logo/lin.jpg')); ?>" class="img-fluid" style="height:50px;">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/mailing/index.blade.php ENDPATH**/ ?>