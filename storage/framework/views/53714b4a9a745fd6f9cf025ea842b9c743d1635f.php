  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        ...
        <img src="<?php echo e(asset('adminDemo/images/logo/4.png')); ?>" alt="Logo" class="img-fluid">
        </a></h1>
      ...
      <nav id="navbar" class="navbar" >
        <ul>
          <li><a class="nav-link scrollto active" href="<?php echo e(route('index')); ?>"><b style="font-family: Satoshi, 69pt regular;">Home</b></a></li>
          <li><a class="nav-link scrollto" href="<?php echo e(route('login')); ?>" style="color:#000;"><b>Registration</b></a></li>
		  ...
		  <li class="dropdown"><a href="#" style="color:#000;"><span><b style="font-family: Satoshi, 69pt regular;">About PPBS</b></span> <i class="bi bi-chevron-down"></i></a>
            <ul style="color:#000;">
				<li><a href="<?php echo e(route('the-school')); ?>" style="color:#000;"><b style="font-family: Satoshi, 69pt regular;">The School</b></a></li>
				<li><a href="<?php echo e(route('the-school')); ?>" style="color:#000;"><b style="font-family: Satoshi, 69pt regular;">Vision & Mission</b></a></li>
				<li><a href="<?php echo e(route('the-school')); ?>" style="color:#000;"><b style="font-family: Satoshi, 69pt regular;">Awarding Partners</b></a></li>
				<li><a href="<?php echo e(route('the-school')); ?>" style="color:#000;"><b style="font-family: Satoshi, 69pt regular;">Student Testimonials</b></a></li>
				<li><a href="#" style="color:#000;"><b style="font-family: Satoshi, 69pt regular;">Policies & Procedures</b></a></li>
 ...
 <?php /**PATH C:\xampp\htdocs\ppbs\resources\views////frontend/parts/header.blade.php ENDPATH**/ ?>