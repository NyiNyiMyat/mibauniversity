                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <img src="<?php echo e(asset('storage/courseimg/courseBanner/'.$course->banner)); ?>" id="img1" class="img-fluid">
                               </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                   ...
                                   <img src="<?php echo e(asset('storage/courseimg/courseTumb/'.$course->tumbnail)); ?>" id="img2" class="img-fluid">
                               </div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/courses/edit.blade.php ENDPATH**/ ?>