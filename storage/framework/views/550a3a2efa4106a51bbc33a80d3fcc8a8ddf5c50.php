    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner" role="listbox">
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url(<?php echo e(asset('images/banner/hel.jpg')); ?>);">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
            <div class="section-title">
              <h2><img src="<?php echo e(asset('images/logo/HELP University Logo.png')); ?>" class="img-fluid" style="height:100px;"><hr>Help University</h2>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/frontend/helpuniversity-info.blade.php ENDPATH**/ ?>