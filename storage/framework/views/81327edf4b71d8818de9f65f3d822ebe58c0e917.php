            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Certificate  Student Details / <a href="<?php echo e(route('certificatebackend.index')); ?>">Back</a></h4>
                    </div>
...
<hr>
                    ...
                    <div class="col-md-12 col-12">
                                ...
                                <hr>
                                <form style="color:#000;"class="form" action="<?php echo e(route('certificatebackend.update',$certificate->id)); ?>" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="course" value="<?php echo e($certificate->course); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="campus" value="<?php echo e($certificate->campus); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="intake" value="<?php echo e($certificate->intake); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                          <label for="first-name-column"><h6><font style="font-size:15px;">Learning Type</font></h6></label>
                                            <select class="form-select" aria-label=".form-select-lg example" name="type" required="required">
                                                <option selected><?php echo e($certificate->type); ?></option>
                    ...
                    <option value="Online-Learning-(Zoom-Class)">Online Learning (Zoom Class)</option>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="fullname" value="<?php echo e($certificate->fullname); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($certificate->gender); ?>" name="gender">
                                        </div>
                                    </div>
<hr>
                                    <div class="col-md-12 col-12">
  ...
  <hr>                                  
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="nrc" value="<?php echo e($certificate->nrc); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nation" value="<?php echo e($certificate->nation); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="relig" value="<?php echo e($certificate->relig); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="father" value="<?php echo e($certificate->father); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="stu_ph" value="<?php echo e($certificate->stu_ph); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="email" value="<?php echo e($certificate->email); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="address" value="<?php echo e($certificate->address); ?>">
                                        </div>
                                    </div>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header bg-primary">
                                                                                <h5 class="modal-title white" id="myModalLabelprofile">
                                                                                    <?php echo e($certificate->fullname); ?>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/app/public/certiimages/'.$certificate->pro)); ?>" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/app/public/certiimages/'.$certificate->pay)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/app/public/certiimages/'.$certificate->nrcf)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/app/public/certiimages/'.$certificate->nrcb)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/certificatebackend/edit.blade.php ENDPATH**/ ?>