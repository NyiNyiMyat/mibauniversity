      ...
      <div class="container" style="background-color:#005393;color:#fff;">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 footer-info" >
           ...
           <div class="col-lg-3 col-md-6 footer-info">
           <br>
              <h5 style="color:#fff;">We have Programs below.</h5><hr>
               <p style="font-size:15px;line-height: 2">
           ...
           <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li><a href="<?php echo e(route('frontend.our-programs',$category->category)); ?>"><?php echo e($category->category); ?></a></li>
...
<?php /**PATH C:\xampp\htdocs\ppbs\resources\views/layouts/app.blade.php ENDPATH**/ ?>