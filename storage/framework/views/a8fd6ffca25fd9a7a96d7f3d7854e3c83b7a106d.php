                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/linmbaimages/'.$linstudent->pro)); ?>" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/linmbaimages/'.$linstudent->pay)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="<?php echo e(asset('storage/linmbaimages/'.$linstudent->nrcf)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="<?php echo e(asset('storage/linmbaimages/'.$linstudent->nrcb)); ?>" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="ratio ratio-16x9">
                                                                                    <iframe width="1000px"src="<?php echo e(asset('storage/linmbaimages/degree/'.$linstudent->degreefile)); ?>" title="Degree" allowfullscreen></iframe>
                                                                                  </div>
                                                                            </div>
                                                                            <div class="modal-footer">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/backend/lincolnbackend/edit.blade.php ENDPATH**/ ?>