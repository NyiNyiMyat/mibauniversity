...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="<?php echo e(route('miniMba.index')); ?>">All Students</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('miniMbaone','1')); ?>">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('miniMbatwo','2')); ?>">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('miniMbathree','3')); ?>">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('miniMba.create')); ?>">Add New Student</a></li>
...
<hr>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        <?php ($no=1); ?>
                        <?php $__currentLoopData = $mini; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/miniimages/'.$student->pro)); ?>" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/miniimages/'.$student->nrcf)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/miniimages/'.$student->nrcb)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/miniimages/'.$student->pay)); ?>" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="<?php echo e(route('miniMba.edit',$student->id)); ?>">
                            ...
                            data-bs-target="#del<?php echo e($student->id); ?>">  <img src="https://img.icons8.com/plasticine/25/000000/filled-trash.png"/>
                        Delete
                        </button>
                        <?php else: ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="<?php echo e(route('miniMba.destroy',$student->id)); ?>" method="POST">
                                  ...
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalScrollableTitle">
                                              Student ID #<?php echo e($student->id); ?> <br> Registration Date: <?php echo e($student->created_at); ?>
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="<?php echo e(asset('storage/app/public/miniimages/'.$student->pro)); ?>" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="<?php echo e(route('miniMba.show',$student->id)); ?>" style="color:#000;">
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">
                    Student ID #<?php echo e($student->id); ?><br> Data Input Date: <?php echo e($student->created_at); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/miniMba/index.blade.php ENDPATH**/ ?>