...
<?php endif; ?>
	                    <form id="regForm" action="<?php echo e(route('sbsmba.store')); ?>" method="post" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
<h3><img src="<?php echo e(asset('images/logo/sbs.png')); ?>" class="img-fluid" style="height:50px;"></h3>
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							...
							<label for="usr">
								...
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" id="usr" value="<?php echo e(Auth::user()->email); ?>" name="email" placeholder="Enter Student's Email" oninput="this.className = ''" readonly>
								</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/frontend/sbsmbapage.blade.php ENDPATH**/ ?>