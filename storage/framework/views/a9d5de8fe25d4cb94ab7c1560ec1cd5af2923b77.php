...
<section  id="about" class="about" style="padding-top:6px;">
     <div class="container-fluid">
        <div class="row">
             <div class="col-md-12">
                 ...
                 <img src="<?php echo e(asset('storage/courseimg/courseBanner/'.$courses->banner)); ?>" class="img-fluid">
    ...
    <div class="container" style="margin-top: 20px;background-color: #fff;">
      <div class="row" style="padding-top: 20px;">
        <div class="col-md-4">
            <img src="<?php echo e(asset('storage/courseimg/courseTumb/'.$courses->tumbnail)); ?>" class="img-fluid">
        </div>
        <div class="col-md-8">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppbs\resources\views/frontend/our-programs/detail.blade.php ENDPATH**/ ?>