         ...
         <li class="dropdown"><a href="#" style="color:#000;"><span><b style="font-family: Satoshi, 69pt regular;">Registration</b></span> <i class="bi bi-chevron-down"></i></a>
          ...
          <?php if(Route::has('login')): ?>
              <?php if(auth()->guard()->check()): ?>
                ...
                <li><a href="<?php echo e(url('backend/account')); ?>"><b style="font-family: Satoshi, 69pt regular;color:#000;">Admin</b></a></li>
                <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\mibauni\resources\views////frontend/parts/header.blade.php ENDPATH**/ ?>