            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Certificate Student Lists</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="<?php echo e(route('certificatebackend.index')); ?>">All Students</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('certificateone','1')); ?>">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('certificatetwo','2')); ?>">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('certificatethree','3')); ?>">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('certificatebackend.create')); ?>">Add New Student</a></li>
...
<hr>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        <?php ($no=1); ?>
                        <?php $__currentLoopData = $certificate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/certiimages/'.$student->pro)); ?>" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/certiimages/'.$student->nrcf)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/certiimages/'.$student->nrcb)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/certiimages/'.$student->pay)); ?>" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="<?php echo e(route('certificatebackend.edit',$student->id)); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="<?php echo e(route('certificatebackend.destroy',$student->id)); ?>" method="POST">
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="<?php echo e(asset('storage/app/public/certiimages/'.$student->pro)); ?>" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="<?php echo e(route('certificatebackend.show',$student->id)); ?>" style="color:#000;">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u921554399/domains/ppbsmyanmar.com/public_html/resources/views/backend/certificatebackend/index.blade.php ENDPATH**/ ?>