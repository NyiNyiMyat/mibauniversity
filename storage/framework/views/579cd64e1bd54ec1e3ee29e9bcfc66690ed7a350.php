                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold"><a href="<?php echo e(route('lincolnbackend.index')); ?>">
                                        Lincoln MBA <?php echo e($linmbastudents->count()); ?></a></h6><br>
                                        <h6 class="text-muted font-semibold"><a href="<?php echo e(route('sbsbackend.index')); ?>">
                                        SBS MBA <br><?php echo e($sbsmbastudents->count()); ?></a></h6>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">  <a href="<?php echo e(route('miniMba.index')); ?>">Mini MBA</a></h6>
                                    <h6 class="font-extrabold mb-0"><?php echo e($mini->count()); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold"><a href="<?php echo e(route('abebackend.index')); ?>">ABE Diploma</a></h6>
                                    <h6 class="font-extrabold mb-0"><?php echo e($abestudents->count()); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="<?php echo e(route('iqnbackendpos.index')); ?>">IQN Diploma</a>
                                    </h6>
                                    <h6 class="font-extrabold mb-0"><?php echo e($iqnstudents->count()); ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body px-3 py-4-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                        <h6 class="text-muted font-semibold"><a href="<?php echo e(route('certificatebackend.index')); ?>">Certificate</a></h6>
                        <h6 class="font-extrabold mb-0"><?php echo e($certificate->count()); ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">IQN Student Lists</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="<?php echo e(route('iqnbackendpos.index')); ?>">All Students</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('iqnone','1')); ?>">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('iqntwo','2')); ?>">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('iqnthree','3')); ?>">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="<?php echo e(route('iqnbackendpos.create')); ?>">Add New Student</a></li>
      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#export">All Export</a></li>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        <?php ($no=1); ?>
                        <?php $__currentLoopData = $iqnstudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="dropdown">
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/iqnposimages/'.$student->pro)); ?>" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/iqnposimages/'.$student->nrcf)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/iqnposimages/'.$student->nrcb)); ?>" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/iqnposimages/'.$student->pay)); ?>" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
    <li><a class="dropdown-item" href="<?php echo e(asset('storage/app/public/iqnposimages/degreefile/'.$student->degreefile)); ?>" download><span class="fa-fw select-all fas"></span>Degree File (only for Post Graduate)</a></li>
</ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="<?php echo e(route('iqnbackendpos.edit',$student->id)); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="<?php echo e(route('iqnbackendpos.destroy',$student->id)); ?>" method="POST">
                                  ...
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalScrollableTitle">
                                              Student ID #<?php echo e($student->id); ?> / Reggistration Date: <?php echo e($student->created_at); ?>
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="<?php echo e(asset('storage/app/public/iqnposimages/'.$student->pro)); ?>" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                        ...
                                        <b>Intake |&nbsp;<font style="color: rgb(54, 52, 52);"><?php echo e($student->intake); ?></font></b><hr>
                                        <b>Learning Type |&nbsp;<font style="color: rgb(54, 52, 52);"><?php echo e($student->type); ?></font></b><hr>
                                        ...
                                        <!--form action="<?php echo e(route('abebackend.destroy',$student->id)); ?>" method="POST">
                                            <?php echo method_field('DELETE'); ?>
                                            <?php echo csrf_field(); ?>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="<?php echo e(route('iqnbackendpos.show',$student->id)); ?>" style="color:#000;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">
                    ...
                    <br> Data Input Date: <?php echo e($student->created_at); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mibauni\resources\views/backend/iqnbackendpos/index.blade.php ENDPATH**/ ?>