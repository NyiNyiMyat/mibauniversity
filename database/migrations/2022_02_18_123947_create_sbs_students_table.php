...
class CreateSbsStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sbs_students', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('degreefile',191)->nullable();
    ...
    {
        Schema::dropIfExists('sbs_students');
    }
}
