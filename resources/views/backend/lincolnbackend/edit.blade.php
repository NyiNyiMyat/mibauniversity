            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Lincoln MBA Student Details / <a href="{{route('lincolnbackend.index')}}">Back</a></h4>
                    </div>
...
<hr>
                    ...
                    <div class="col-md-12 col-12">
                                ...
                                <hr>
                                <form class="form" action="{{route('lincolnbackend.update',$linstudent->id)}}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="course" value="{{$linstudent->course}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="campus" value="{{$linstudent->campus}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="intake" value="{{$linstudent->intake}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="fullname" value="{{$linstudent->fullname}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="{{$linstudent->gender}}" name="gender">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nation" value="{{$linstudent->nation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="relig" value="{{$linstudent->relig}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="father" value="{{$linstudent->father}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="stu_ph" value="{{$linstudent->stu_ph}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="email" value="{{$linstudent->email}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="address" value="{{$linstudent->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="occupation" value="{{$linstudent->occupation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="com_name" value="{{$linstudent->com_name}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="com_ph" value="{{$linstudent->com_ph}}">
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-column" class="form-control"
                         name="ad_year" value="{{$linstudent->ad_year}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="last-name-column" class="form-control"
                        value="{{$linstudent->university}}" name="university">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="city-column" class="form-control"
                            name="degree" value="{{$linstudent->degree}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="country-floating" class="form-control"
                            name="major" value="{{$linstudent->major}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="location" value="{{$linstudent->location}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="company-column" class="form-control"
                            name="certificate" value="{{$linstudent->certificate}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="ad_date" value="{{$linstudent->ad_date}}">
                    </div>
                </div>
                ...
                <br><br>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_name" value="{{$linstudent->em_name}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-column" class="form-control"
                                            name="em_rela" value="{{$linstudent->em_rela}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_comph" value="{{$linstudent->em_comph}}">
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="{{asset('storage/app/public/linmbaimages/'.$linstudent->pro)}}" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/app/public/linmbaimages/'.$linstudent->pay)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="{{asset('storage/app/public/linmbaimages/'.$linstudent->nrcf)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/app/public/linmbaimages/'.$linstudent->nrcb)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="ratio ratio-16x9">
                                                                                    <iframe width="1000px"src="{{asset('storage/app/public/linmbaimages/degree/'.$linstudent->degreefile)}}" title="Degree" allowfullscreen></iframe>
                                                                                  </div>
                                                                            </div>
                                                                            <div class="modal-footer">
