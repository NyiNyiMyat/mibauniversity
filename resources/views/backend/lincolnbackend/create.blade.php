            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Lincoln MBA Student / <a href="{{route('lincolnbackend.index')}}">Back</a></h4>
                    </div>
          
                    <div class="card-content">
                        <div class="card-body">
                        <h3><img src="{{asset('images/logo/lin.jpg')}}" class="img-fluid" style="height:50px;"></h3>
                    <div class="col-md-12 col-12">
                    <form id="regForm" action="{{route('lincolnbackend.store')}}" method="post" enctype="multipart/form-data">
							@csrf
