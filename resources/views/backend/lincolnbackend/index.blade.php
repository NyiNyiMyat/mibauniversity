                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="{{route('lincolnbackend.index')}}">Lincoln MBA Student Registration Lists</a>
                                    </h6>
                                    <h6 class="font-extrabold mb-0">{{$linmbastudents->count()}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{$sbsmbastudents->count()}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="{{route('lincolnbackend.create')}}">Add New Student</a></li>
...
<hr>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        @php($no=1)
                        @foreach($linmbastudents as $student)
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="{{asset('storage/linmbaimages/'.$student->pro)}}" download><span class="fa-fw select-all fas" style="width:17px;"></span> Student Photo</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/linmbaimages/degree/'.$student->degreefile)}}" download><span class="fa-fw select-all fas" style="width:17px;"></span> Degree File</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/linmbaimages/'.$student->nrcf)}}" download><span class="fa-fw select-all fas" style="width:17px;"></span> N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/linmbaimages/'.$student->nrcb)}}" download><span class="fa-fw select-all fas" style="width:17px;"></span> N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/linmbaimages/'.$student->pay)}}" download><span class="fa-fw select-all fas" style="width:17px;"></span> Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            <td>
                            ...
                            <td>
                            <a href="{{route('lincolnbackend.edit',$student->id)}}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="{{route('lincolnbackend.destroy',$student->id)}}" method="POST">
                                                    @METHOD('DELETE')
                                                    @csrf
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="{{asset('storage/linmbaimages/'.$student->pro)}}" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="{{route('lincolnbackend.show',$student->id)}}" style="color:#000;">
