            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        ...
                        <!--tr id="sid{{$course->id}}">
                            <td>
                        <input type="checkbox" class="checkBoxClass" id="{{$course->id}}" name="ids" value="{{$course->id}}" >
                     ...
                     <button id="del" class="btn" data-bs-toggle="modal"
                            data-bs-target="#del{{$course->id}}"><img src="https://img.icons8.com/plasticine/25/000000/filled-trash.png"/>
                        Delete
                        </button>
                        @else
                     ...
                     @endif
                            ...
                            <div class="modal fade" id="del{{$course->id}}" tabindex="-1" role="dialog"
