                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold"><a href="{{route('categories.index')}}">Course Categories</a></h6>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">  <a href="{{route('type.index')}}">Course Types</a></h6>
                                    <h6 class="font-extrabold mb-0">{{ $coursetype->count() }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold"><a href="{{route('courses.index')}}">Course</a></h6>
                                    <h6 class="font-extrabold mb-0">{{ $courses->count() }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold"> <a href="{{route('contactUs.index')}}">Student Contact Lists</a></h6>
            ...
            <div class="card">
                <div class="card-body px-3 py-4-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h6 class="text-muted font-semibold"> <a href="{{route('enquiry.index')}}">Student Enquiry</a></h6>
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        ...
                        <!---tr id="sid{{$category->id}}">
                            <td>
                        <input type="checkbox" class="checkBoxClass" id="{{$category->id}}" name="ids" value="{{$category->id}}" >
                            ...
                            <td>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable{{$category->id}}">
                     ...
                     <button id="del" class="btn" data-bs-toggle="modal"
                            data-bs-target="#del{{$category->id}}"><img src="https://img.icons8.com/plasticine/25/000000/filled-trash.png"/>
                        Delete
                        </button>
                     ...
                     @endif
                            ...
                            <div class="modal fade" id="del{{$category->id}}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" placeholder="Category"
                                                        class="form-control" name="category" value="{{$category->category}}">
                                                </div>
                                                <br>
                                               
                                                <div class="form-group">
                                                <textarea class="form-control" cols="30" rows="10" name="description">{{$category->description}}</textarea>
                                                </div>
                                                <br>
                                                <label style="color:#000">Banner 5288x838: </label>
                                                <br><br>
                                              ...
                                              <img src="{{asset('storage/app/public/courseBanner/'.$category->banner)}}" class="img-fluid" style="width:250px;">
