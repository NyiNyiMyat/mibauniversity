        ...
        <div class="col-12 col-lg-12">
            <div class="row">
                <div class="col-12 col-lg-12 col-md-12">
                  ...
                  <img src="{{asset('images/banner/abeba.png')}}" class="img-fluid"  style="border-radius: 30px;border:3px solid blue;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Add New ABE Student / <a href="{{route('abebackendZoom.index')}}">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="{{route('abebackendZoom.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
