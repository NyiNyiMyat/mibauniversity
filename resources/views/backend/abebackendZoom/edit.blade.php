            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ABE Student Details / <a href="{{route('abebackend.index')}}">Back</a></h4>
                    </div>
...
<hr>
                    ...
                    <div class="col-md-12 col-12">
                                ...
                                <hr>
                                <form class="form" action="{{route('abebackendZoom.update',$abestudentzoom->id)}}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="course" value="{{$abestudentzoom->course}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="campus" value="{{$abestudentzoom->campus}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="intake" value="{{$abestudentzoom->intake}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="fullname" value="{{$abestudentzoom->fullname}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="{{$abestudentzoom->gender}}" name="gender">
                                        </div>
                                    </div>

                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">D.O.B</label>
                                            <input type="date" id="city-column" class="form-control" placeholder="Date Of Birth"
                                                name="dob" value="{{$abestudentzoom->dob}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control"
                                                name="nrc" value="{{$abestudentzoom->nrc}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nation" value="{{$abestudentzoom->nation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="relig" value="{{$abestudentzoom->relig}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="father" value="{{$abestudentzoom->father}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="stu_ph" value="{{$abestudentzoom->stu_ph}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="email" value="{{$abestudentzoom->email}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="address" value="{{$abestudentzoom->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="occupation" value="{{$abestudentzoom->occupation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="com_name" value="{{$abestudentzoom->com_name}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="com_ph" value="{{$abestudentzoom->com_ph}}">
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-column" class="form-control"
                         name="ad_year" value="{{$abestudentzoom->ad_year}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="last-name-column" class="form-control"
                        value="{{$abestudentzoom->university}}" name="university">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="city-column" class="form-control"
                            name="degree" value="{{$abestudentzoom->degree}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="country-floating" class="form-control"
                            name="major" value="{{$abestudentzoom->major}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="location" value="{{$abestudentzoom->location}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="company-column" class="form-control"
                            name="certificate" value="{{$abestudentzoom->certificate}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="ad_date" value="{{$abestudentzoom->ad_date}}">
                    </div>
                </div>
                ...
                <br><br>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_name" value="{{$abestudentzoom->em_name}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-column" class="form-control"
                                            name="em_rela" value="{{$abestudentzoom->em_rela}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_comph" value="{{$abestudentzoom->em_comph}}">
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="{{asset('storage/abezoomimages/'.$abestudentzoom->pro)}}" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/abezoomimages/'.$abestudentzoom->pay)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="{{asset('storage/abezoomimages/'.$abestudentzoom->nrcf)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/abezoomimages/'.$abestudentzoom->nrcb)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
