        ...
        <div class="col-12 col-lg-12">
            <div class="row">
                <div class="col-12 col-lg-12 col-md-12">
                  ...
                  <img src="{{asset('images/banner/abefa.png')}}" class="img-fluid"  style="border-radius: 30px;border:3px solid blue;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New IQN Student / <a href="{{route('iqnbackendpos.index')}}">Back</a></h4>
                    </div>
          
                    <div class="card-content">
                        <div class="card-body">
                            <h3><img src="{{asset('images/logo/iqn.png')}}" class="img-fluid" style="width:140px;"></h3>
                    <div class="col-md-12 col-12">
                    <form id="regForm" action="{{route('iqnbackendpos.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
