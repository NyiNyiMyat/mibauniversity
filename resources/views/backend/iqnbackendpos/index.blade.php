...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="{{route('iqnbackendpos.index')}}">All Students</a></li>
      <li><a class="dropdown-item" href="{{route('iqnone','1')}}">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="{{route('iqntwo','2')}}">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="{{route('iqnthree','3')}}">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="{{route('iqnbackendpos.create')}}">Add New Student</a></li>
      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#export">All Export</a></li>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        @php($no=1)
                        @foreach($iqnstudents as $student)
...
<div class="dropdown">
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="{{asset('storage/app/public/iqnposimages/'.$student->pro)}}" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/iqnposimages/'.$student->nrcf)}}" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/iqnposimages/'.$student->nrcb)}}" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/iqnposimages/'.$student->pay)}}" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/iqnposimages/degreefile/'.$student->degreefile)}}" download><span class="fa-fw select-all fas"></span>Degree File (only for Post Graduate)</a></li>
</ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="{{route('iqnbackendpos.edit',$student->id)}}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="{{route('iqnbackendpos.destroy',$student->id)}}" method="POST">
                                                    @METHOD('DELETE')
                                                    @csrf
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="{{asset('storage/app/public/iqnposimages/'.$student->pro)}}" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                        ...
                                        <!--form action="{{route('abebackend.destroy',$student->id)}}" method="POST">
                                            @METHOD('DELETE')
                                            @csrf
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="{{route('iqnbackendpos.show',$student->id)}}" style="color:#000;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">
                    ...
                    <br> Data Input Date: {{$student->created_at}}
                 </h5>
                <button type="button" class="close" data-bs-dismiss="modal"
                    aria-label="Close">
                    <i data-feather="x"></i>
