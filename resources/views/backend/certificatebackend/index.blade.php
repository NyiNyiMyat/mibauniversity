...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="{{route('certificatebackend.index')}}">All Students</a></li>
      <li><a class="dropdown-item" href="{{route('certificateone','1')}}">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="{{route('certificatetwo','2')}}">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="{{route('certificatethree','3')}}">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="{{route('certificatebackend.create')}}">Add New Student</a></li>
...
<hr>
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="{{asset('storage/app/public/certiimages/'.$student->pro)}}" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/certiimages/'.$student->nrcf)}}" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/certiimages/'.$student->nrcb)}}" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/certiimages/'.$student->pay)}}" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="{{route('certificatebackend.edit',$student->id)}}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="{{route('certificatebackend.destroy',$student->id)}}" method="POST">
                                                    @METHOD('DELETE')
                                                    @csrf
                                  ...
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalScrollableTitle">
                                              Student ID #{{$student->id}} / Registration Date: {{$student->created_at}}
                                           </h5>
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="{{asset('storage/app/public/certiimages/'.$student->pro)}}" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="{{route('certificatebackend.show',$student->id)}}" style="color:#000;">
