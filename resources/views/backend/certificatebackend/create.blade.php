            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New Certificate Student / <a href="{{route('certificatebackend.index')}}">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="{{route('certificatebackend.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
