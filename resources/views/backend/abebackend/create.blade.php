            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New ABE Student / <a href="{{route('abebackend.index')}}">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="{{route('abebackend.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
