...
<hr>
                    ...
                    <div class="col-md-12 col-12">
                                ...
                                <hr>
                                <form class="form" action="{{route('abebackend.update',$abestudent->id)}}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="course" value="{{$abestudent->course}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="campus" value="{{$abestudent->campus}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="intake" value="{{$abestudent->intake}}">
                                        </div>
                                    </div>
...
<div class="form-group">
      <label for="first-name-column"><h6><font style="font-size:15px;">Learning Type</font></h6></label>
        <select class="form-select" aria-label=".form-select-lg example" name="type" required="required">
            <option selected>{{$abestudent->type}}</option>
...
<option value="Online-Learning-(Zoom-Class)">Online Learning (Zoom Class)</option>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                             name="fullname" value="{{$abestudent->fullname}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="{{$abestudent->gender}}" name="gender">
                                        </div>
                                    </div>
<hr>
                                    <div class="col-md-12 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="nation" value="{{$abestudent->nation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="relig" value="{{$abestudent->relig}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="father" value="{{$abestudent->father}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="stu_ph" value="{{$abestudent->stu_ph}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="email" value="{{$abestudent->email}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="address" value="{{$abestudent->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="occupation" value="{{$abestudent->occupation}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control"
                                                name="com_name" value="{{$abestudent->com_name}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                name="com_ph" value="{{$abestudent->com_ph}}">
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name-column" class="form-control"
                         name="ad_year" value="{{$abestudent->ad_year}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="last-name-column" class="form-control"
                        value="{{$abestudent->university}}" name="university">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="city-column" class="form-control"
                            name="degree" value="{{$abestudent->degree}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="country-floating" class="form-control"
                            name="major" value="{{$abestudent->major}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="location" value="{{$abestudent->location}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="company-column" class="form-control"
                            name="certificate" value="{{$abestudent->certificate}}">
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="email-id-column" class="form-control"
                            name="ad_date" value="{{$abestudent->ad_date}}">
                    </div>
                </div>
                ...
                <br><br>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_name" value="{{$abestudent->em_name}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-column" class="form-control"
                                            name="em_rela" value="{{$abestudent->em_rela}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company-column" class="form-control"
                                            name="em_comph" value="{{$abestudent->em_comph}}">
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <img src="{{asset('storage/app/public/abeimages/'.$abestudent->pro)}}" class="img-fluid">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/app/public/abeimages/'.$abestudent->pay)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                <img src="{{asset('storage/app/public/abeimages/'.$abestudent->nrcf)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
                                                                    ...
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <img src="{{asset('storage/app/public/abeimages/'.$abestudent->nrcb)}}" class="img-fluid">
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-light-secondary"
                                                                                        data-bs-dismiss="modal">
