...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      ...
      <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$abestudent->pro)}}" download><span class="fa-fw select-all fas"></span> Student Photo</a></li>
   
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$abestudent->nrcf)}}" download><span class="fa-fw select-all fas"></span> N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$abestudent->nrcb)}}" download><span class="fa-fw select-all fas"></span> N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$abestudent->pay)}}" download><span class="fa-fw select-all fas"></span> Payment Screenshot Image</a></li>
      <li><a href="" class="dropdown-item" onclick="printDiv('printableArea')">
      <span class="fa-fw select-all fas"></span> Print or Download</a></li>
      <li><a class="dropdown-item" href="{{route('abebackend.edit',$abestudent->id)}}"><span class="fa-fw select-all fas"></span> Edit Student</a></li>
    </ul>
  </div>
</div>
<hr>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-12 col-12">
                ...
                <form action="{{route('abebackend.destroy',$abestudent->id)}}" method="POST">
                    @METHOD('DELETE')
                    @csrf
...
<tbody>
    <tr style="color:#000;">
     <th colspan="3"></th>
     <th><img src="{{asset('storage/app/public/abeimages/'.$abestudent->pro)}}" style="width:100px;height:100px"></th>
    </tr>

    <tr>
     <th colspan="4" style="color:#000;">{{$abestudent->course}}</th>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->created_at}}</td>
    <td class="text-bold-500">{{$abestudent->fullname}}</td>
    <td class="text-bold-500">{{$abestudent->intake}}</td>
    <td class="text-bold-500">{{$abestudent->gender}}</td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->email}}</td>
    <td class="text-bold-500">{{$abestudent->nrc}}</td>
    <td class="text-bold-500">{{$abestudent->stu_ph}}</td>
    <td class="text-bold-500">{{$abestudent->dob}}</td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->nation}}</td>
    <td class="text-bold-500">{{$abestudent->relig}}</td>
    <td class="text-bold-500">{{$abestudent->father}}</td>
    <td class="text-bold-500">{{$abestudent->address}}</td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->occupation}}</td>
    <td class="text-bold-500">{{$abestudent->com_name}}</td>
    <td class="text-bold-500">{{$abestudent->com_ph}}</td>
    <td></td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->ad_year}}</td>
    <td class="text-bold-500">{{$abestudent->university}}</td>
    <td class="text-bold-500">{{$abestudent->degree}}</td>
    <td class="text-bold-500">{{$abestudent->major}}</td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->other_ql}}</td>
    <td class="text-bold-500">{{$abestudent->location}}</td>
    <td class="text-bold-500">{{$abestudent->certificate}}</td>
    <td class="text-bold-500">{{$abestudent->ad_date}}</td>
    </tr>
    ...
    <tr style="color:#000;">
    <td class="text-bold-500">{{$abestudent->em_name}}</td>
    <td class="text-bold-500">{{$abestudent->em_rela}}</td>
    <td class="text-bold-500">{{$abestudent->em_comph}}</td>
