...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="{{route('abebackend.index')}}">All Students</a></li>
      <li><a class="dropdown-item" href="{{route('abeone','1')}}">Face To Face on Campus</a></li>
      <li><a class="dropdown-item" href="{{route('abetwo','2')}}">E-Learning Platform</a></li>
      <li><a class="dropdown-item" href="{{route('abethree','3')}}">Online Learning (Zoom Class)</a></li>
      <li><a class="dropdown-item" href="{{route('abebackend.create')}}">Add New Student</a></li>
...
<hr>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        @php($no=1)
                        @foreach($abestudents as $student)
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$student->pro)}}" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$student->nrcf)}}" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$student->nrcb)}}" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/app/public/abeimages/'.$student->pay)}}" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            ...
                            <td>
                            <a href="{{route('abebackend.edit',$student->id)}}">
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="{{asset('storage/app/public/abeimages/'.$student->pro)}}" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="{{route('abebackend.show',$student->id)}}" style="color:#000;">
