            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        ...
                        <!--tr id="id{{$type->id}}">
                            <td>
                        <input type="checkbox" class="checkBoxClass" id="{{$type->id}}" name="ids" value="{{$type->id}}" >
                            ...
                            <td>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#inlineForm{{$type->id}}">
                     ...
                     <button id="del" class="btn" data-bs-toggle="modal"
                            data-bs-target="#del{{$type->id}}"><img src="https://img.icons8.com/plasticine/25/000000/filled-trash.png"/>
                        Delete
                        </button>
                        @else
                       ...
                       @endif
                            ...
                            <div class="modal fade" id="del{{$type->id}}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal fade text-left" id="inlineForm{{$type->id}}" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel33" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        role="document">
                                        <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" placeholder="coursetype"
                                                            class="form-control" name="coursetype" value="{{$type->coursetype}}">
                                                    </div>
                                                </div>
