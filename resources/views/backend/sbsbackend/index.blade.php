...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
      <li><a class="dropdown-item" href="{{route('sbsbackend.create')}}">Add New Student</a></li>
      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#export">All Export</a></li>
            ...
            <div class="card-body">
                ...
                <table class="table" id="table1" style="font-size:15px;color:#000;">
                    ...
                    <tbody>
                        @php($no=1)
                        @foreach($sbsmbastudents as $student)
 ...
 <span class="fa-fw select-all fas"></span>Download Items
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="{{asset('storage/sbsmbaimages/degree'.$student->degreefile)}}" download><span class="fa-fw select-all fas"></span>Degree File</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/sbsmbaimages/sbsimages/'.$student->pro)}}" download><span class="fa-fw select-all fas"></span>Student Photo</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/sbsmbaimages/sbsimages/'.$student->nrcf)}}" download><span class="fa-fw select-all fas"></span>N.R.C Front Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/sbsmbaimages/sbsimages/'.$student->nrcb)}}" download><span class="fa-fw select-all fas"></span>N.R.C Back Image</a></li>
    <li><a class="dropdown-item" href="{{asset('storage/sbsmbaimages/sbsimages/'.$student->pay)}}" download><span class="fa-fw select-all fas"></span>Payment Screenshot Image</a></li>
  </ul>
</div>
                            </td>
                            <td>
                            ...
                            <td>
                            <a href="{{route('sbsbackend.edit',$student->id)}}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                ...
                                                <form action="{{route('sbsbackend.destroy',$student->id)}}" method="POST">
                                                    @METHOD('DELETE')
                                                    @csrf
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="avatar avatar-xl me-3">
                                            <img src="{{asset('storage/app/public/sbsmbaimages/sbsimages/'.$student->pro)}}" style="width:100px;height:100px">
                                        </div>
                                        <br><br>
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          <a href="{{route('sbsbackend.show',$student->id)}}" style="color:#000;">
