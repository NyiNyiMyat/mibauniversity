            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add SBS MBA Student / <a href="{{route('sbsbackend.index')}}">Back</a></h4>
                    </div>
                    ...
                    <form id="regForm" action="{{route('sbsbackend.store')}}" method="post" enctype="multipart/form-data">
							@csrf
