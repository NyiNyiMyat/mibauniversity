...
@section('content')
        ...
        @endif
	                    ...
	                    <form id="regForm" action="{{route('iqndiploma.store')}}" method="post" enctype="multipart/form-data">
							...
							<h3><img src="{{asset('userDemo/img/iqn.png')}}" class="img-fluid" style="width:150px;"></h3>
							  ...
							  <script type="text/javascript">
								  ...
								  reader.readAsDataURL(event.target.files[0]);
											  ...
											  <div class="form-group">
												<label for="usr"><h6><font style="font-size: 15px;">Choose Your Profile Photo (pro)</font><font style="color:red;font-size:20px;">*</font></h6></label>
												<br>
...
<h5 class="modal-title" id="myModalLabel1">Your Profile Photo</h5>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							...
							<input type="text" class="form-control" id="usr"  name="course" value="Post Graduate Diploma in Business Management" oninput="this.className = ''" readonly>
 							</div>


						  <div class="form-group">
							<label for="usr"><h6><font style="font-size: 15px;">Upload Your Degree (degreefile)</font><font style="color:red;font-size:20px;">*</font></h6></label>
							<input type="file"  name="degreefile" id="degreefile" value="-" class="form-control" accept="application/pdf">
						 </div>
 ...
 <div class="modal fade" id="myModal2">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
      <div class="modal-header">
<h5 class="modal-title" id="myModalLabel1">Your Profile Payment Screenshot</h5>
</div>
