...
<section  id="about" class="about" style="padding-top:6px;">
     <div class="container-fluid">
        <div class="row">
             <div class="col-md-12">
                 ...
                 <img src="{{asset('storage/app/public/courseimg/courseBanner/'.$courses->banner)}}" class="img-fluid">
    ...
    <div class="container" style="margin-top: 20px;background-color: #fff;">
      <div class="row" style="padding-top: 20px;">
        <div class="col-md-4">
            <img src="{{asset('storage/app/public/courseimg/courseTumb/'.$courses->tumbnail)}}" class="img-fluid">
        </div>
        <div class="col-md-8">
         <h4><img src="https://img.icons8.com/color/20/000000/courses.png"/> <b>{{$courses->coursename}}</b></h4>
            <br>
       <p style="line-height:2;">
        <b style="line-height:2;"> 
          {!!html_entity_decode($courses->description1)!!}</b></p> 
       <p>
  ...
  <b><i class="bi bi-arrow-right-circle"></i> Course Description</b>
      ...
      <div class="collapse" id="des2">
        <div class="card card-body">
          <p style="line-height:2;">
            <b style="line-height:2;"> 
              {!!html_entity_decode($courses->description2)!!}</b></p> 
      ...
      <div class="collapse" id="des3">
        <div class="card card-body">
          <p style="line-height:2">
            <b style="line-height:2"> 
              {!!html_entity_decode($courses->description3)!!}</b></p> 
      ...
      <div class="collapse" id="des4">
        <div class="card card-body">
          <p style="line-height:2">
            <b style="line-height:2"> 
              {!!html_entity_decode($courses->description4)!!}</b></p> 
           <p>
        </div>
      </div>
<hr>
 <a class="btn btn-primary" href="{{route('login')}}" style="color:#fff;"><b>Register Now</b></a>
  ...
  @endif
      ...
      <div class="col-lg-12">
        <form action="{{route('our-programs.store')}}" method="post" role="form" class="">
          @csrf
          <div class="form-row">
          ...
          <div class="form-row">
            <div class="col-lg-6 form-group">
              <input type="text" name="course" class="form-control" id="course" placeholder="Course" value="{{$courses->coursename}}" readonly/>
            </div>
    ...
    <div class="card item">
      <a href="{{route('frontend.our-programs.detail',$course->id)}}">
        ...
        <div class="card-body" id="bgcourse" style="height: 10rem;">
          <p class="card-text">
            <i class="bi bi-border-width"></i> <h4>{{$course->coursename}}</h4>
            </p>
        </div>
