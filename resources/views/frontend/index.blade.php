    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url({{asset('images/slide/1.png')}});">
            <div class="carousel-container">
              ...
              <h2 class="animate__animated animate__fadeInDown">
               MIBA University</h2>
                ...
                <a href="{{route('the-school')}}" class="btn-get-started animate__animated animate__fadeInUp scrollto" style="bak">Read More</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url({{asset('images/slide/3.png')}});">
            <div class="carousel-container">
              ...
              <h2 class="animate__animated animate__fadeInDown">
                ...
                <!-- Slide 4 -->
                <div class="carousel-item" style="background-image: url({{asset('images/slide/web412.jpg')}});">
            <div class="carousel-container">
              <div class="carousel-content container">
              <h2 class="animate__animated animate__fadeInDown">
...
<!-- ======= Awarding Lists Section ======= -->
        ...
        <section class="about-lists" id="program"  style="background-color:#8b070b;">
      <div class="container-fluid">
        <div class="row no-gutters">
          @foreach($categories as $category)
          <div class="col-lg-3 col-md-5 content-item">
               <h5 style="color:#fff;"><i class="bi bi-journal-check" style="color:#fff;font-size:30px;"></i> {{$category->category}}</h5>
             <h6 style="font-size:17px;color:#fff;text-align:left;line-height:150%;">
              {{ \Illuminate\Support\Str::limit($category->description, 160, $end='...') }}

</h6><a href="{{route('frontend.our-programs',$category->category)}}">
...
<section class="about-lists" id="program">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <form  action="{{route('search_course')}}" method="GET">
            @csrf
    ...
    <hr>
      ...
      <div class="container">
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6 content-item">
                 <img src="{{asset('images/address/mict2.jpg')}}" class="img-fluid" style="height:220px;border:1px solid blue;border-radius:10px;box-shadow:1px 2px 1px #333;"><br><br>
                 <a href="{{route('contact-us')}}"><h6 style="color:#000;"><b><img src="https://img.icons8.com/color/30/000000/arrow--v2.png"/>&nbsp;MICT Center</b></h6></a>
          </div>


          <div class="col-lg-4 col-md-6 content-item">
                 <img src="{{asset('images/address/mdy.jpg')}}" class="img-fluid" style="height:220px;border:1px solid blue;border-radius:10px;box-shadow:1px 2px 1px #333;"><br><br>
                 <a href="{{route('contact-us')}}"><h6 style="color:#000;"><b><img src="https://img.icons8.com/color/30/000000/arrow--v2.png"/>&nbsp;Mandalay Center</b></h6></a>
          </div>
          <div class="col-lg-2 col-md-6 content-item"></div>
          <!---------
