...
@endif
	                    <form id="regForm" action="{{route('miniMba.store')}}" method="POST" enctype="multipart/form-data">
							@csrf
						<h3><img src="{{asset('images/logo/4.png')}}" class="img-fluid" style="width:100px;"> MINI MBA</h3>
