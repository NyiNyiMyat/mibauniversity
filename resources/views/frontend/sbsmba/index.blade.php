...
<h3 style="text-align:center">SBS MBA</h3>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						  ...
						  <div class="form-group">
							...
							<input type="file"  name="degreefile" id="degreefile"  oninput="this.className = ''" class="form-control" accept="application/pdf" required>
						 </div>
