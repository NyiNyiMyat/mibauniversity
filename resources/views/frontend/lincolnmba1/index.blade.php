...
@section('content')
	...
	<h3 style="text-align:center">Lincoln MBA</h3>
	                    <form id="regForm" action="{{route('lincolnmba.store')}}" method="post" enctype="multipart/form-data">
							@csrf
							<h3><img src="{{asset('images/logo/lin.png')}}" class="img-fluid" style="height:50px;"></h3>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						  ...
						  <div class="form-group">
							<label for="usr"><h6><font style="font-size: 15px;">Upload Your Degree [pdf only] (degreefile)</font><font style="color:red;font-size:20px;">*</font></h6></label>
							<input type="file"  name="degreefile" id="degreefile"  oninput="this.className = ''" class="form-control"  required>
						 </div>
