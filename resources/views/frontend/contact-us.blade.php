...
<section id="contact" class="contact">
        ...
        <div class="row">
             <div class="col-md-12">
                 <img src="{{asset('images/banner/Campus.jpg')}}" class="img-fluid"  style="width:100%;">
             </div>
        </div>
    </div><br>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 d-flex align-items-stretch" style="font-size:15px;">
            <div class="info-box">
                <h3>MICT Center</h3>
                <img src="{{asset('images/banner/Mict Park Campus.jpg')}}" class="img-fluid" style="height:220px;border:1px solid #0667b2;border-radius:10px;box-shadow:1px 2px 1px #333;"><br><br>
          ...
          <div class="col-lg-4 d-flex align-items-stretch" style="font-size:15px;">
            <div class="info-box">
                <img src="{{asset('images/banner/welcome.png')}}" class="img-fluid" style="width:320px;">
                <br><br>
          ...
          <div class="col-lg-4 d-flex align-items-stretch" style="font-size:15px;">
            <div class="info-box ">
                ...
                <img src="{{asset('images/banner/Mingalar Mandalay Campus.jpg')}}" class="img-fluid" style="height:220px;border:1px solid #0667b2;border-radius:10px;box-shadow:1px 2px 1px #333;"><br><br>
                <i class="bx bx-map"></i><h3>Address</h3>
                 Block 6, Unit -6, Flower Street,   Mingalar Mandalay Compound,
