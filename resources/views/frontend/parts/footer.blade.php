  ...
  <!-- ======= Footer ======= -->
  <footer id="footer" style="background-color:#8b070b;">
    <div class="footer-top" style="background-color:#8b070b;">
      <div class="container" style="background-color:#8b070b;">

        <div class="row">
          <div class="col-lg-3 col-md-6 footer-info">
              <h4>ABOUT MIBA</h4><hr>
            <p  style="font-size:15px;line-height: 2;">
            <a href="{{route('the-school')}}" style="color:#fff;">MIBA University</a><br>
            <a href="{{route('the-school')}}" style="color:#fff;">Vision & Mission</a><br>
            <a href="https://cpanel01wh.bkk1.cloud.z.com:2096/" style="color:#fff;" target="_blan">Staff E-Mail</a><br>
            <a href="{{route('the-school')}}" style="color:#fff;">Student Testimonials</a><br>
            <a href="{{route('contact-us')}}" style="color:#fff;">Contact Us</a><br>
            </p>
          </div>
           <div class="col-lg-3 col-md-6 footer-info">
              <h4>PROGRAMS</h4><hr>
              ...
              <a style="color:#fff;" href="{{route('frontend.our-programs',$category->category)}}">{{$category->category}}</a><br>
              @endforeach
            </p>
          </div>
          <div class="col-lg-3 col-md-6 footer-info">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            @foreach($celebrations as $celebrate)
              <a href="{{route('events',$celebrate->id)}}" style="color:#fff;"><b style="font-family: Satoshi, 69pt regular;color:#fff;">
              {{$celebrate->name}}</b></a><br>
              @endforeach
            <!--a href="" style="color:#fff;">Photo Gallery</a><br>
            <a href="" style="color:#fff;">Video Gallery</a><br--->

            <a href="{{route('privacy-and-data-protection')}}" style="color:#fff;">Privacy and Data Protection</a><br>
            </p>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        ...
        </script> <span>MIBA University</span>.<br>
